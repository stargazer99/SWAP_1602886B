...
<div class="main">
  ...
  <form action="beforeupdate.php" method="post">
...
<form action="beforeviewaccountinfo.php" method="post">
  ...
  <form action="beforeviewcreditcardinfo.php" method="post">
  <div class="inner"><button class="button">View Credit Card info</button></div>
  </form>
  <body bgcolor="#FEFDFD">
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
	<a href="moviechosen.php">Dr Strange - $10.00</a>	
  </div>
</div>
