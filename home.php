...
<div class="navbar">
  ...
  <form action="beforeregister.php" method="post">
  <div class="inner"><button class="button">Register</button></div>
  </form>
  <form action="beforelogin.php" method="post">
  <div class="inner"><button class="button">Login</button></div>
  </form>
</div>
</div>
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href="startingpage.php">Dr Strange</a>
